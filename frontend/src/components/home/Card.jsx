...
const Card = ({ book }) => {
  ...
  return (
    <div
      key={book._id}
      className="border-2 border-gray-500 rounded-lg px-4 py-2 m-4 relative shadow-2xl hover:shadow-lg"
    >
      <h2 className="absolute top-1 right-2 px-4 py-1 bg-blue-400 text-white rounded-lg">
        {book.publishYear}
      </h2>
      ...
      <div className="flex justify-start items-center gap-x-2">
        ...
        <h2 className="my-1 text-green-600">${book.price}</h2>
      </div>
      <div className="flex justify-between items-center gap-x-2 mt-4 p-4">
        <BiShow className="text-3xl text-blue-400 hover:text-black" onClick={() => setShowModel(true)} />
